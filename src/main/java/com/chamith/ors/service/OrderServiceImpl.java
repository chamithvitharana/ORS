...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderServiceImpl(OrderRepository orderRepository, UserRepository userRepository, FoodRepository foodRepository, OrderItemRepository orderItemRepository) {
